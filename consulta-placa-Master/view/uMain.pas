unit uMain;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///                   OLA ESTA É UMA API DE CONSULTAR PLACA                                                                            ////
...
///                   A API QUE ESTOU USANDO NESTE EXEMPLO É A API Placa Dados Free                                                 ////
///               *** PARA MAIS INFORMAÇÃO https://github.com/guilhermepires06                                                     ////
///                                                                                                                               ////
///                                                                                                                              ////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
interface
...
begin
  ...
  try
    URL := 'https://cluster.apigratis.com/api/v1/login';    // Link para fazer a autenticação
                                                           // cria a autenticação, essa autenticação nao muda
...
var
  ...
  Confirma: Integer;
begin
  if edtPlaca.Text = EmptyStr then                                              // Faz a pergunta se realmente é esta placa que deseja comprar
    Exit;
...
begin
  ...
  if MemoLog.Lines.Count = 0 then                                        // Verificar se o MemoLog está vazio
    Exit;
